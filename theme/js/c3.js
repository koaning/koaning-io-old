! function(a) {
    ...
    k.generate = function(a) {
        ...
        var a = this;
        return a.config.title_y + a.title.node().getBBox().height
        ...
        var a = this;
        a.title = a.svg.append("text").text(a.config.title_text).attr("class", "c3-chart-title").attr("x", a.config.title_x).attr("y", a.config.title_y)
    }, i.redrawTitle = function() {
        var a = this;
        a.title.attr("x", a.config.title_x).attr("y", a.config.title_y || a.title.node().getBBox().height)
    ...
    h.focus = function(a) {
        ...
        return function() {
            var e, f, g, h = a.targets,
                ...
                z = b.x.domain(),
                A = i.duration || s,
                B = i.done || function() {}, C = b.generateWait(),
